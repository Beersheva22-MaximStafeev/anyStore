...
const SignInForm: React.FC<Props> = ({ submitFn }) => {
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        const email: string = (event.nativeEvent as SubmitEvent).submitter?.id === "GoogleButton" ? "GOOGLE" : data.get('email')! as string;
                ...
                >
                    ...
                    <Box component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 1 }}>
                        <Grid container justifyContent={'center'} spacing={3}>
                            ...
                            <Grid item xs={12} >
                                <Button id="GoogleButton" type="submit" fullWidth variant="contained">Sign In With Google</Button>
                            </Grid>
                        </Grid>
